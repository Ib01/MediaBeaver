...
public class MediaMoverIT
{
	...
	@Test
	public void moveTest() throws XmlRpcException, IOException
	{
		MediaMover mm = Factory.getMediaMover(com.ibus.mediabeaver.core.util.Platform.CLI, configuration);
